package com.exampleapp.fooddeliveryapp.Common;
...
import com.exampleapp.fooddeliveryapp.Model.TokenModel;
import com.exampleapp.fooddeliveryapp.Model.UserModel;
import com.exampleapp.fooddeliveryapp.R;
import com.exampleapp.fooddeliveryapp.services.MyFCMServices;
...
public class Common {
    ...
    public static void showNotification(Context context, int id, String title, String content, Intent intent) {
        ...
        String NOTIFICATION_CHANNEL_ID = "example_app_food_delivery_app";
        NotificationManager notificationManager = (NotificationManager)context.getSystemService(Context.NOTIFICATION_SERVICE);
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O)
        {
            NotificationChannel notificationChannel = new NotificationChannel(NOTIFICATION_CHANNEL_ID,
                    "FoodDeliveryApp",NotificationManager.IMPORTANCE_DEFAULT);
            notificationChannel.setDescription("FoodDeliveryApp");
