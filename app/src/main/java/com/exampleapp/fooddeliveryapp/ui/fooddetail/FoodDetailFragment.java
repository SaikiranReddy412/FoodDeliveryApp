...
import com.exampleapp.fooddeliveryapp.ui.comments.CommentFragment;
...
public class FoodDetailFragment extends Fragment implements TextWatcher {
    ...
    void  onCartItemAdd(){
        ...
        cartItem.setFoodExtraPrice(Common.calculateExtraPrice(Common.selectedFood.getUserSelectedSize(),Common.selectedFood.getUserSelectedAddon())); // Because default we not choose size + addon so extra prize is 0
    ...
    private void displayUserSelectedAddon() {
        ...
        } else //if (Common.selectedFood.getUserSelectedSize() != null && Common.selectedFood.getUserSelectedAddon().size() == 0)
                ...
                .addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                        if (dataSnapshot.exists()){
                           ...
                           // double result = sumRating/ratingCount; deleted
